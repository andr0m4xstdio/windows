...
echo "	1) Windows 2019 (Link Mati)"
echo "	2) Windows 2016 (Link Mati)"
echo "	3) Windows 2012"
echo "	4) Windows 10 (Link Mati)"
echo "	5) Windows 2022 (Link Mati)"
...
case "$PILIHOS" in
	...
	3) PILIHOS="https://master.dl.sourceforge.net/project/nixpoin/windows2012.gz?viasf=1"  IFACE="Ethernet Instance 0 2";;
